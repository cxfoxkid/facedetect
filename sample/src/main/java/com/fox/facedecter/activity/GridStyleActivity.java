...
import com.fox.facedecter.adapter.PostAdapter;
...
public class GridStyleActivity extends BaseActivity {
    ...
    private String[] IMG_URL_LIST = {
        ...
        "http://cdnq.duitang.com/uploads/item/201505/20/20150520102944_CiL3M.jpeg",
        "http://h.hiphotos.baidu.com/image/pic/item/43a7d933c895d1430295e2e97af082025baf071c.jpg",
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //for (int i = 0; i < 18; i++) {
            ...
            imgUrls.addAll(Arrays.asList(IMG_URL_LIST).subList(0, 13));
            Post post = new Post("图库：", imgUrls);
            mPostList.add(post);
        //}
